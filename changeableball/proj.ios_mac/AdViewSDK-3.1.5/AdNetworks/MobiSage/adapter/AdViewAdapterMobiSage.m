...
- (void)actGetAd {
	...
	if (nil != mobiSageAdViewManagerClass)
        [[MobiSageManager getInstance] setPublisherID:apID auditFlag:@"IOS_AppStore_v6.4.2"];
    ...
    MobiSageBanner* adView= [[mobiSageAdBannerClass alloc] initWithDelegate:self
                                                            adType:bannerType
                                                         slotToken:slotToken
                                                      intervalTime:Ad_Refresh_30
                                                   switchAnimeType:Random];
