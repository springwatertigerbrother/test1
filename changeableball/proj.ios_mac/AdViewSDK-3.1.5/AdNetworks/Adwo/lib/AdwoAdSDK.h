...
// Adwo Ad SDK版本号的数值表示
#define ADWO_SDK_VERSION                    0x66

// Adwo Ad SDK版本号的字符串表示
#define ADWO_SDK_VERSION_STRING             @"6.6"
...
#define adwoAdETARequestedAndActivated  FUCKU_ETARequestedAndActivated
#define adwoAdETAReceivedSpecifiedFeatureCode   FUCKU_ETAReceivedSpecifiedFeatureCode
#define adwoAdETAAnimationComplete  FUCKU_AssETAAnimationComplete
#define adwoUserClosedETA           FUCKU_GodClosedETA
...
#define AdwoAdSetETADelegate    FUCKU_SetETADelegate
#define AdwoAdGetETAViewSizes   FUCKU_GetETAViewSizes
#define AdwoAdAddETAViewToSuperview FUCKU_AddETAViewToSuperview
#define AdwoAdAddETAViewWithAnimation   FUCKU_AddETAViewWithAnimation
#define AdwoAdRemoveETAViewFromSuperview    FUCKU_RemoveETAViewFromSuperview
#define AdwoAdGetVoicePrintAdInfo   FUCKU_GetVoicePrintAssInfo
#define AdwoAdOpenETATracking   FUCKU_OpenETATracking
#define AdwoAdCloseETATracking  FUCKU_CloseETATracking
...
{
    ADWOSDK_IMAD_SHOW_FORM_COMMON,          // 普通植入性广告
    ADWOSDK_FSAD_SHOW_FORM_VIDEO,           // 视频激励性广告
};
 ...
 * @return 如果返回为空，表示广告初始化创建失败，开发者可以通过调用AdwoAdGetLatestErrorCode接口来获取错误码。如果创建成功，则返回一个UIView对象，作为广告对象句柄。
*/
extern UIView* AdwoAdCreateImplantAd(NSString *pid, BOOL showFormalAd, NSObject<AWAdViewDelegate> *delegate, NSString *adInfo,enum ADWOSDK_IMAD_SHOW_FORM imAdForm);
