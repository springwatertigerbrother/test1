...
- (void)getAd {
    ...
    [smadManagerClass setDebugMode:YES];
	...
	smartView = [[smartMadAdViewClass alloc]
	...
	smartView.rootViewController=[[UIApplication sharedApplication].keyWindow rootViewController];
	self.adNetworkView = smartView;
}

- (void)stopBeingDelegate {
  //SMAdBannerView *_smartView = (SMAdBannerView*)self.adNetworkView;
