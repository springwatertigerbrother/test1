...
#define kAdViewDefaultConfigURL				@"http://test2014.adview.cn:8088/agent/agent1.php"
                                          //@"http://test2014.adview.cn:8088/agent/agent1.php"
#define kAdViewDefaultImpMetricURL			@"http://test2014.adview.cn:8088/agent/agent2.php"
#define kAdViewDefaultClickMetricURL		@"http://test2014.adview.cn:8088/agent/agent3.php"
#define kAdViewDefaultCustomAdURL			@"http://test2014.adview.cn:8088/agent/custom.php"
#define CONFIG_REACH_CHECK		1			//现在的check针对ip:124.207.233.116不可行，域名估计没问题, laizhiwen

#else

#define kAdViewDefaultConfigURL				@"http://config.adview.cn/agent/agent1.php"
#define kAdViewDefaultImpMetricURL			@"http://report.adview.cn/agent/agent2.php"
#define kAdViewDefaultClickMetricURL		@"http://report.adview.cn/agent/agent3.php"
#define kAdViewDefaultCustomAdURL			@"http://report.adview.cn/agent/custom.php"
